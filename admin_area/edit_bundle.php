        ...
        <div class="card-body">
          <form method="post" enctype="multipart/form-data">
            <div class="form-group form-row">
              <label for="" class="col-form-label col-md-3 px-5 text-right">Bundle Title</label>
              <div class="col-md-6">
                <input type="text" name="product_title" class="form-control" value="<?= $p_title ?>" required>
              </div>
            </div>
            <div class="form-group form-row">
              <label for="" class="col-form-label col-md-3 px-5 text-right">Bundle Slug</label>
              <div class="col-md-6">
            ...
            <div class="form-group form-row">
              <label for="" class="col-form-label col-md-3 px-5 text-right">Bundle Category</label>
              <div class="col-md-6">
            ...
            <div class="form-group form-row">
              <label for="" class="col-form-label col-md-3 px-5 text-right">Bundle Image 1</label>
              <div class="col-md-6">
            ...
            <div class="form-group form-row">
              <label for="" class="col-form-label col-md-3 px-5 text-right">Bundle Image 2</label>
              <div class="col-md-6">
            ...
            <div class="form-group form-row">
              <label for="" class="col-form-label col-md-3 px-5 text-right">Bundle Image 3</label>
              <div class="col-md-6">
            ...
            <div class="form-group form-row">
              <label for="" class="col-form-label col-md-3 px-5 text-right">Bundle Price</label>
              <div class="col-md-6">
                <input type="text" name="product_price" class="form-control" value="<?= $p_price ?>" required>
              </div>
            </div>
            <div class="form-group form-row">
              <label for="" class="col-form-label col-md-3 px-5 text-right">Bundle Sale Price</label>
              <div class="col-md-6">
                <input type="text" name="psp_price" class="form-control" value="<?= $psp_price ?>">
              </div>
            </div>
            <div class="form-group form-row">
              <label for="" class="col-form-label col-md-3 px-5 text-right">Bundle Keywords</label>
              <div class="col-md-6">
                <input type="text" name="product_keywords" class="form-control" value="<?= $p_keywords ?>" required>
              </div>
            </div>
            <div class="form-group form-row">
              <label for="" class="col-form-label col-md-3 px-5 text-right">Bundle Tabs</label>
              <div class="col-md-6">
                <ul class="nav nav-pills mb-3">
                  <li class="nav-item">
                    <a class="nav-link active" href="#description" data-toggle="pill" role="tab">Bundle Description</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="#features" data-toggle="pill" role="tab">Bundle Features</a>
                  </li>
                  <li class="nav-item">
            ...
            <div class="form-group form-row">
              <label for="" class="col-form-label col-md-3 px-5 text-right">Bundle Label</label>
              <div class="col-md-6">
            ...
            <div class="form-group form-row">
              ...
              <div class="col-md-6">
                <input type="submit" value="Update Bundle" name="update" class="btn btn-primary form-control">
              </div>
            </div>
          </form>
        </div>
